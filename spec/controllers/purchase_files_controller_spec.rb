...
describe PurchaseFilesController do
  ...
  describe "GET edit" do
    it "assigns the requested purchase_file as @purchase_file" do
      purchase_file = PurchaseFile.create! valid_attributes
      get :edit, {:id => purchase_file.to_param}, valid_session
      assigns(:purchase_file).should eq(purchase_file)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new PurchaseFile" do
        expect {
          post :create, {:purchase_file => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved purchase_file as @purchase_file" do
        ...
        PurchaseFile.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested purchase_file" do
        purchase_file = PurchaseFile.create! valid_attributes
        # Assuming there are no other purchase_files in the database, this
        # specifies that the PurchaseFile created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        PurchaseFile.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => purchase_file.to_param, :purchase_file => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested purchase_file as @purchase_file" do
        purchase_file = PurchaseFile.create! valid_attributes
        put :update, {:id => purchase_file.to_param, :purchase_file => valid_attributes}, valid_session
        assigns(:purchase_file).should eq(purchase_file)
      end

      it "redirects to the purchase_file" do
        purchase_file = PurchaseFile.create! valid_attributes
        put :update, {:id => purchase_file.to_param, :purchase_file => valid_attributes}, valid_session
        response.should redirect_to(purchase_file)
      end
    end

    describe "with invalid params" do
      it "assigns the purchase_file as @purchase_file" do
        purchase_file = PurchaseFile.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        PurchaseFile.any_instance.stub(:save).and_return(false)
        put :update, {:id => purchase_file.to_param, :purchase_file => {}}, valid_session
        assigns(:purchase_file).should eq(purchase_file)
      end
